...
<form action=""method="post">
    ...
    <div class="modal fade" id="instructor" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="staticBackdropLabel">Register Instructor Account</h1>
      ...
      <div class="modal-body">
        ...
        <select class="form-select form-select-lg mb-3"name="usertype"id="floatingInput" aria-label=".form-select-lg example">
            ...
            <option disabled value="user">Student Pilot (Contact the Administrator!)</option>
