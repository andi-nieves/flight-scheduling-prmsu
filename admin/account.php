    ...
    <div class="d-flex" id="wrapper"><!--start d-flex wrapper-->
        ...
        <div class="bg-white" id="sidebar-wrapper"><!-- Sidebar -->
            ...
            <div class="list-group list-group-flush my-2 mx-1">
                ...
                <a href="account.php" class="list-group-item list-group-item-action second-text active "><i class="fa-duotone fa-users me-2"></i>Accounts</a>
...
<div class="table-responsive mx-3 bg-light py-3 rounded-3 vh-100">
        ...
        <hr>
        <button type="button" id="addAccount" class="btn btn-primary mb-3 ms-2" data-bs-toggle="modal" data-bs-target="#accountModal"><i class="fa-duotone fa-plus"></i> Add User Account</button>
        <div class="card mx-2">
                ...
                if(mysqli_num_rows($query_run) > 0)
                {
                    foreach($query_run as $user)
                    {
                        ...
                        <tr>
                            ...
                            <td data-label="Contact number"><?= $user['contact'] ?></td>
                            <td data-label="User type"><?= $user['usertype'] ?></td>
                            <td>
                                <center>
                                <button type="button" value="<?=$user['id'];?>" class="viewUser btn btn-outline-info btn-sm"><i class="fa-duotone fa-eye mx-1"></i></button>
                                <button type="button" value="<?=$user['id'];?>" class="editUser btn btn-outline-success btn-sm"><i class="fa-duotone fa-pen-to-square mx-1"></i></button>
                                <button type="button" value="<?=$user['id'];?>" class="delUser btn btn-outline-danger btn-sm"><i class="fa-duotone fa-trash mx-1"></i></button>
                                </center>
                            </td>
                        </tr>
                        <?php
