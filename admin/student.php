    ...
    <div class="d-flex" id="wrapper"><!--start d-flex wrapper-->
        ...
        <div class="bg-white" id="sidebar-wrapper"><!-- Sidebar -->
            ...
            <div class="list-group list-group-flush my-2 mx-1">
                ...
                <a href="student.php" class="list-group-item list-group-item-action second-text active "><i class="fa-duotone fa-user-pilot me-2"></i>Pilot Student</a>
...
<div class="table-responsive mx-3 bg-light py-3 rounded-3 vh-100">
        <center>
            <h4>STUDENT PILOT LIST</h4>
        </center>
        <hr>
        <button type="button" id="addStudent" class="btn btn-primary mb-3 ms-2" data-bs-toggle="modal" data-bs-target="#studentModal"><i class="fa-duotone fa-plus"></i> Add Student Pilot</button>
        <div class="card mx-2">
                ...
                if(mysqli_num_rows($query_run) > 0)
                {
                    foreach($query_run as $student)
                    {
                        ...
                        <tr>
                            ...
                            <td data-label="Contact number"><?= $student['contact'] ?></td>
                            <td data-label="Gender"><?= $student['gender'] ?></td>
                            <td data-label="Address"><?= $student['address'] ?></td>
                            <td data-label="Email"><?= $student['email'] ?></td>
                            <td data-label="License Expiration"><?= $student['license'] ?></td>
                            <td>
                                <center>
                                <button type="button" value="<?=$student['id'];?>" class="viewStudent btn btn-outline-info btn-sm"><i class="fa-duotone fa-eye mx-1"></i></button>
                                <button type="button" value="<?=$student['id'];?>" class="editStudent btn btn-outline-success btn-sm"><i class="fa-duotone fa-pen-to-square mx-1"></i></button>
                                <button type="button" value="<?=$student['id'];?>" class="delStudent btn btn-outline-danger btn-sm"><i class="fa-duotone fa-trash mx-1"></i></button>
                                </center>
                            </td>
                        </tr>
                        <?php
