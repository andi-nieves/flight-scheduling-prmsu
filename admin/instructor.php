...
<div class="table-responsive mx-3 bg-light py-3 rounded-3 vh-100">
        ...
        <hr>
        <button type="button" id="addInstructor" class="btn btn-primary mb-3 ms-2" data-bs-toggle="modal" data-bs-target="#instructorModal"><i class="fa-duotone fa-plus"></i> Add Instructor</button>
        <div class="card mx-2">
                ...
                if(mysqli_num_rows($query_run) > 0)
                {
                    foreach($query_run as $instructor)
                    {
                        ...
                        <tr>
                            ...
                            <td>
                                <center>
                                <button type="button" value="<?=$instructor['id'];?>" class="viewInstructor btn btn-outline-info btn-sm"><i class="fa-duotone fa-eye mx-1"></i></button>
                                <button type="button" value="<?=$instructor['id'];?>" class="editInstructor btn btn-outline-success btn-sm"><i class="fa-duotone fa-pen-to-square mx-1"></i></button>
                                <button type="button" value="<?=$instructor['id'];?>" class="delInstructor btn btn-outline-danger btn-sm"><i class="fa-duotone fa-trash mx-1"></i></button>
                                </center>
                            </td>
                        </tr>
                        <?php
