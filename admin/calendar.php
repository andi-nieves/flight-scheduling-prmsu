				...
				<div class="img-container">
                    ...
                    <div class="col-lg-6 col-sm-12">  
							<div class="form-group">
							  ...
							  <input type="date" name="date" id="date" class="form-control mb-2" placeholder="Date of Filling">
							</div>
						</div>
						<div class="col-lg-12 col-sm-12">  
							<div class="form-group">
							  <label for="orginator">Orginator</label>
							  <input type="text" name="orginator" id="orginator" class="form-control mb-2" placeholder="Enter Orginator">
							</div>
						</div>						
                        <div class="col-lg-12 col-sm-12">  
							<div class="form-group">
							  <label for="event_name">Aircraft</label>
							  <input type="text" name="event_name" id="event_name" class="form-control mb-2"  placeholder="Enter your Aircraft">
							</div>
						</div>
                        <div class="col-lg-6 col-sm-12">  
							<div class="form-group">
							  <label for="flight_crew">Flight Crew</label>
							  <input type="text" name="flight_crew" id="flight_crew" class="form-control mb-2" placeholder="Enter Flight Crew">
							</div>
						</div>
                        <div class="col-lg-6 col-sm-12">  
							<div class="form-group">
							  <label for="passenger">Passengers</label>
							  <input type="text" name="passenger" id="passenger" class="form-control mb-2" placeholder="Enter Passenger">
							</div>
						</div>
                        <div class="col-lg-6 col-sm-12">  
							<div class="form-group">
							  <label for="pilot_command">Pilot in Command</label>
							  <input type="text" name="pilot_command" id="pilot_command" class="form-control mb-2" placeholder="Enter Pilot in Command">
							</div>
						</div>
                        <div class="col-lg-6 col-sm-12">  
							<div class="form-group">
							  <label for="person_board">Persons on Board</label>
							  <input type="text" name="person_board" id="person_board" class="form-control mb-2" placeholder="Enter Persons on Board">
							</div>
						</div>
                        <div class="col-lg-4 col-sm-12">  
							<div class="form-group">
							  <label for="cruising_speed">Cruising Speed</label>
							  <input type="text" name="cruising_speed" id="cruising_speed" class="form-control" placeholder="Enter Cruising Speed">
							</div>
						</div>
                        <div class="col-lg-4 col-sm-12">  
							<div class="form-group">
                        ...
                        <div class="col-lg-4 col-sm-12">  
							<div class="form-group">
							  ...
							  <input type="text" name="route" id="route" class="form-control mb-2" placeholder="Enter Route">
							</div>
						</div>
                        <div class="col-lg-12 col-sm-12">  
							<div class="form-group">
							  <label for="destination_aerodome">Destination Aerodome</label>
							  <input type="text" name="destination_aerodome" id="destination_aerodome" class="form-control mb-2" placeholder="Enter Destination Aerodome">
							</div>
						</div>
					</div>
					<div class="row">
                    <div class="col-lg-12 col-sm-12">  
							<div class="form-group">
							  <label for="event_start_date">Flight Schedule</label>
							  <input type="date" name="event_start_date" id="event_start_date" class="form-control mb-2" placeholder="Event start date">
							 </div>
						</div>

                        <div class="col-lg-6 col-sm-12">  
							<div class="form-group">
							  <label for="start_time">Flight Start</label>
							  <input type="time" name="start_time" id="start_time" class="form-control mb-2" placeholder="start time">
							 </div>
						</div>
						<div class="col-lg-6 col-sm-12">  
							<div class="form-group">
							  <label for="end_time">Flight End</label>
